...
- [OracleForge](https://oracle.maxiaworld.app) - Real-time price feed oracle for LLM agents. Multi-source (Pyth, Chainlink, Uniswap v3), token budget awareness, MCP server.
